...
/**
 * InkMOD http://forum.minecraftuser.jp/viewtopic.php?f=13&t=3397
 *
 * 0:bucketInk
 */
public class BlockDrinkServerInk extends BlockDrinkServerAbstract {
	// 素材アイテム
	public static Item[] itemType;

	public BlockDrinkServerInk(int blockID, int textureStartCoord, Item[] itemType) {
		super(blockID, textureStartCoord, 1);
